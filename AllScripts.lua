if game.PlaceId == 11545598432 then
	...
	function autoKillFreeza()
	while getgenv().autoKillFreeza == true do
		wait()
		game.Players.LocalPlayer.Character:SetPrimaryPartCFrame(game:GetService("Workspace").Scriptable.Bosses["_friezy"].HumanoidRootPart.CFrame)
		local ohString1 = "Equip"
		local ohString2 = "Sword"
		local ohBoolean3 = true
	...
	function autoKillHDemon()
	while getgenv().autoKillHDemon == true do
		wait()
		game.Players.LocalPlayer.Character:SetPrimaryPartCFrame(game:GetService("Workspace").Scriptable.Bosses["_handDemon"].HumanoidRootPart.CFrame)
		local ohString1 = "Equip"
		local ohString2 = "Sword"
		local ohBoolean3 = true
	...
	function autoKillArlong()
	while getgenv().autoKillArlong == true do
		wait()
		game.Players.LocalPlayer.Character:SetPrimaryPartCFrame(game:GetService("Workspace").Scriptable.Bosses["_arlongo"].HumanoidRootPart.CFrame)
		local ohString1 = "Equip"
		local ohString2 = "Sword"
		local ohBoolean3 = true
	...
	function autoKillShukaku()
	while getgenv().autoKillShukaku == true do
		wait()
		game.Players.LocalPlayer.Character:SetPrimaryPartCFrame(game:GetService("Workspace").Scriptable.Bosses["_desertBoss"].HumanoidRootPart.CFrame)
		local ohString1 = "Equip"
		local ohString2 = "Sword"
		local ohBoolean3 = true
	...
	function autoKillTitan()
	while getgenv().autoKillTitan == true do
		wait()
		game.Players.LocalPlayer.Character:SetPrimaryPartCFrame(game:GetService("Workspace").Scriptable.Bosses["_armoredtitan"].HumanoidRootPart.CFrame)
		local ohString1 = "Equip"
		local ohString2 = "Sword"
		local ohBoolean3 = true
	...
	function autoKillMonkey()
		while getgenv().autoKillMonkey == true do
			wait()
			game.Players.LocalPlayer.Character:SetPrimaryPartCFrame(game:GetService("Workspace").Scriptable.Bosses["_ape"].HumanoidRootPart.CFrame)
			local ohString1 = "Equip"
			local ohString2 = "Sword"
			local ohBoolean3 = true
		...
		function autoKillOver()
			while getgenv().autoKillOver == true do
				wait()
				game.Players.LocalPlayer.Character:SetPrimaryPartCFrame(game:GetService("Workspace").Scriptable.Bosses["_overhaul"].HumanoidRootPart.CFrame)
				local ohString1 = "Equip"
				local ohString2 = "Sword"
				local ohBoolean3 = true
	...
	while getgenv().autoPain == true do
		wait()
		game.Players.LocalPlayer.Character:SetPrimaryPartCFrame(game:GetService("Workspace").Scriptable.Bosses["_pain"].HumanoidRootPart.CFrame)
		local ohString1 = "Equip"
		local ohString2 = "Sword"
		local ohBoolean3 = true
